...
ActiveRecord::Schema.define(version: 2020_08_27_232535) do
  ...
  create_table "projects_boards", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["name", "project_id"], name: "index_projects_boards_on_name_and_project_id", unique: true
  ...
  create_table "projects_issues", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["number", "project_id"], name: "index_projects_issues_on_number_and_project_id", unique: true
